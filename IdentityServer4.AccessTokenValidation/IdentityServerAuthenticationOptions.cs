...
namespace IdentityServer4.AccessTokenValidation
{
    ...
    public class IdentityServerAuthenticationOptions : AuthenticationSchemeOptions
    {
        ...
        /// <summary>
        /// Converts to kendecryptionkey.
        /// </summary>
        /// <value>
        /// The token decryption key.
        /// </value>
        public SecurityKey TokenDecryptionKey { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether [require signed tokens].
        /// </summary>
        /// <value>
        ///   <c>true</c> if [require signed tokens]; otherwise, <c>false</c>.
        /// </value>
